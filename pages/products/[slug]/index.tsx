                ...
                <div>
                    ...
                    {cartData ? (
                        <div className="flex items-center justify-start mt-4 space-x-4">
                            ...
                            <span className="text-blue-700 font-semibold text-lg">{cartData.quantity}</span>
                            <button
                        ...
                        {filteredMatchingProductsArray.map((related) => (
                            ...
                            >
                                ...
                                <div className="mt-2 flex justify-center">
                                    <p className="text-blue-600 text-xl font-semibold">₹{related.price}</p>
                                </div>
                                ...
                                {related?.cartQty > 0 ? (
                                    <div className="flex items-center justify-center mt-4 space-x-4">
                                        ...
                                        <span className="text-blue-700 font-semibold text-lg">{related.cartQty}</span>
                                        <button
