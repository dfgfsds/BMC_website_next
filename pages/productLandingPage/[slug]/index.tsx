...
<section className="relative bg-gradient-to-r from-blue-50 to-blue-100 my-12 py-16 px-4 sm:px-6 lg:px-8">
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
      ...
      {/* Feature 1 */}
      <div className="bg-white rounded-2xl shadow-xl p-6 hover:shadow-2xl hover:scale-105 transition duration-300">d
...
<section className="relative bg-blue-50 my-12 py-16 px-4 sm:px-6 lg:px-8">
