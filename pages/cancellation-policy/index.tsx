...
export default function CancellationPolicy() {
  const schemaData = {
    ...
    url: "https://www.brilliantmemorycomputers.in/cancellation-policy",
    description:
      "Cancellation policy of Brilliant Memory Computers Chennai outlining order cancellation rules, timelines, and conditions.",
    publisher: {
      "@type": "Organization",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="cancellation policy Brilliant Memory Computers, order cancellation Chennai, laptop order cancellation Chennai, computer shop cancellation policy India, electronics order cancel Chennai, IT store cancellation terms Chennai, Brilliant Memory Computers cancellation terms"
        />
        ...
        <link
          rel="canonical"
          href="https://www.brilliantmemorycomputers.in/cancellation-policy"
        />
        ...
        <meta
          property="og:url"
          content="https://www.brilliantmemorycomputers.in/cancellation-policy"
        />
        <meta
      ...
      <div className="bg-white p-5 shadow-md rounded-lg lg:p-20">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <p>
            At Brilliant Memory Computers, we aim to provide the best
            products and services to our customers. This Refund &
            Cancellation Policy outlines the conditions under which
            orders may be canceled or refunded.
          </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                Info@brilliantmemorycomputers.in with your order number.
              </li>
              <li>
                Once the order has been processed or shipped, it cannot
                be canceled.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Refunds are applicable only for defective, damaged, or
                incorrectly delivered products.
              </li>
              <li>
                To be eligible for a refund, you must notify us within
          ...
          <section>
            ...
            <p>
              ...
              Info@brilliantmemorycomputers.in with the following
              details:
            </p>
            ...
            <p className="mt-3">
              ...
              approved, the refund will be processed within 7–10
          ...
          <section>
            ...
            <p>
              ...
              for returning your item unless the return is due to our
              error. We recommend using a trackable shipping service or
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Products returned without original packaging or
                accessories
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              Contact us within 48 hours of delivery to initiate the
              process.
            </p>
          </section>
