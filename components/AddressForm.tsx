    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (errObj && errObj.error) {
                const errorStr = String(errObj.error);
                if (errorStr.includes('Postal code must be exactly 6 digits') || errorStr.includes('invalid')) {
                    setPostalCodeError("Postal code must be exactly 6 digits.");
                    toast.error("Postal code must be exactly 6 digits.");
                } else {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                className={`${inputClass} ${postalCodeError ? 'border-red-500 focus:ring-red-500' : ''}`}
