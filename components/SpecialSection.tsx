...
const features = [
  {
    icon: <Truck className="text-blue-600 w-10 h-10" />,
    title: 'Worldwide Shipping',
    description: 'Enjoy free delivery on every order.',
  },
  {
    icon: <RotateCw className="text-blue-600 w-10 h-10" />,
  ...
  {
    icon: <Headphones className="text-blue-600 w-10 h-10" />,
    title: 'Online Customer Service',
    description: (
      <>
        Call our expert <span className="text-blue-600 font-semibold">+91-7788996684</span>
      </>
    ),
  },
];
