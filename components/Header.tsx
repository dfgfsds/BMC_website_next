            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between relative h-full">
                ...
                <div className="ml-auto flex items-center gap-3">
                    ...
                    <div className="flex">
                        ...
                        <button
                            className="text-gray-700 hover:text-blue-600 transition flex"
                            ...
                            {userName ? (
                                <>
                                    <button
                                        ...
                                        className="flex items-center gap-2 hover:text-blue-600 transition text-xl"
                                    >
                                        <User size={20} />
                                ...
                                <Link href="/login" className="flex items-center gap-2 hover:text-blue-600 transition text-lg">
                                    <User size={20} />
                                    <span>Login</span>
                                </Link>
                            )}
